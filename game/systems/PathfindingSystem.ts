...
export class PathfindingSystem {
    ...
    gridWidth: number;
    gridHeight: number;
    _pathRequestsThisFrame: number;
    _maxPathRequestsPerFrame: number;

    constructor(obstacleManager: ObstacleManagerLike, worldWidth: number, worldHeight: number, cellSize = 25) {
    ...
    update(_deltaTime: number, _systems?: SystemManager): void {
        this._pathRequestsThisFrame = 0;
    }
    ...
    isWalkable(gridX: number, gridY: number, entityWidth: number, entityHeight: number): boolean {
