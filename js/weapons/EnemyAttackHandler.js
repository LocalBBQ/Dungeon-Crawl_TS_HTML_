...
class EnemyAttackHandler {
    constructor(weaponOrAttackDef, behaviorType, options = {}) {
        ...
        this.behaviorType = behaviorType || 'slashOnly';
    ...
    getSlashSweepProgress() {
        if (this.isLunging) return 1; // blade forward during lunge
        ...
        const eased = 1 - (1 - raw) ** 4; // easeOutQuart: snappy end like player
        return eased;
    }
}

if (typeof window !== 'undefined') {
    window.EnemyAttackHandler = EnemyAttackHandler;
}
